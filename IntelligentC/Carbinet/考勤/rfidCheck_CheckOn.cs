...
namespace Carbinet
{
    ...
    public class rfidCheck_CheckOn
    {
        ...
        static string SqlCheckEPCUsed =
            @"select count(xh) from person where uniqueID = '{0}'";
        ...
        public static DataTable GetPersonDataSet()
        {
        ...
        public static bool PersonUpdate(Person p)
        {
            ...
            try
            {
                if (InitialDB())
                {
                    ...
                    result = int.Parse(CsharpSQLiteHelper.ExecuteNonQuery(SqlUpdatePerson, pars).ToString());
                    if (result >= 1)
                    {
                        bR = true;
                    }
        ...
        public static bool DeletePersonEPC(string xh)
        {
            ...
            try
            {
                if (InitialDB())
                {
                    ...
                    result = int.Parse(CsharpSQLiteHelper.ExecuteNonQuery(SqlDeletePersonEPC, pars).ToString());
                    if (result >= 1)
                    {
                        bR = true;
                    }
        ...
        public static bool UpdatePersonEPC(string xh, string epc)
        {
            ...
            try
            {
                if (InitialDB())
                {
                    ...
                    result = int.Parse(CsharpSQLiteHelper.ExecuteNonQuery(SqlUpdatePersonEPC, pars).ToString());
                    if (result >= 1)
                    {
                        bR = true;
                    }
        ...
        public static List<string> GetbjList()
        {
            ...
            try
            {
                if (InitialDB())
                {
                    dt = CsharpSQLiteHelper.ExecuteTable(SqlGetbj, null);
        ...
        public static DataTable GetUnCheckedPersonDataSet(string dateStart, string dateEnd)
        {
            DataTable dt = null;
            try
            {
                if (InitialDB())
                {
                    dt = CsharpSQLiteHelper.ExecuteTable(SqlSelectUnCheckedPersonInPeriod
